...
![L'écran de bienvenue de l'assistant de configuration](images/wc-wizard-1.png)
...
![La création des pages WooCommerce](images/wc-wizard-2.png)
...
![Définir l'emplacement de la boutique](images/wc-wizard-3.png)
...
![Activation des taux de taxes](images/wc-wizard-4.png)
...
![Options des taux de taxes](images/wc-wizard-5.png)
...
![Sélection des modes de paiement](images/wc-wizard-6.png)
...
![Votre boutique est prête !](images/wc-wizard-7.png)
...
![Mettre à jour les données](images/wc-update-data.png)
...
![La documentation WooCommerce, une mine d'or !](images/wc-docs-1.png)
...
![Documentation: commencer avec WooCommerce](images/wc-docs-2.png)
...
![La barre de recherche de plugins](images/wc-install-plugins.png)
...
![Installer un plugin depuis WordPress.org](images/wc-install-plugins-2.png)

Dès que ce bouton est cliqué, le téléchargement du plugin démarre:

![Installation du plugin en cours...](images/wc-install-plugins-loading.png)

Vous n'avez ensuite qu'à activer le plugin:

![Activation du plugin](images/wc-install-plugins-activate.png)
...
![Quelques uns des plugins officiels](images/wc-install-plugins-list.png)
